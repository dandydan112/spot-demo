# backend/routers/spot/__init__.py
from fastapi import APIRouter
from . import spot, status, stream, perception, visualizer, spot_battery, camera_stream
...
router.include_router(camera_stream.router)  # /camera_stream/...