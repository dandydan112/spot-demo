...
from backend.config import SPOT_CONFIG #CONFIGGEN
...
def main():
    ...
    from backend.config import SPOT_CONFIG
    robot = sdk.create_robot(SPOT_CONFIG["hostname"])

    robot.authenticate(SPOT_CONFIG["username"], SPOT_CONFIG["password"])
